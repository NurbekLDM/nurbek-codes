...
function RetroGrid(_a) {
    ...
    return (<div className={(0, utils_1.cn)("pointer-events-none absolute size-full overflow-hidden [perspective:200px]", "opacity-[var(--opacity)]", className)} style={gridStyles} {...props}>
