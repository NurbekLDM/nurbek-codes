  ...
  return (
    <div className="relative">
      <Head>
        ...
        <meta name="description" content="Nurbek Aliqo'ziyev — tajribali MERN-stack dasturchi. React, Node.js, TypeScript , Next.js va zamonaviy web texnologiyalar bo‘yicha ekspert." />
        ...
        <meta name="twitter:title" content="Nurbek Aliqo'ziyev | MERN-stack Developer" />
        <meta name="twitter:description" content="Professional MERN-stack developer specializing in React, Next, Node.js, and TypeScript." />
